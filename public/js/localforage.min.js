// Why are you reading this? this file will NOT be touched by me, im far too much of a dumbass for that. Maybe amp will, fuck if I know.
								...
								'onreadystatechange' in
									...
									? function () {
											...
											(b.onreadystatechange =
												...
												a.document.documentElement.appendChild(
													b
												);
										}
									: function () {
				...
				function (a, b, c) {
					...
					function C(a) {
						...
						f || ((f = B()), (ya[d.name] = f)),
							f.forages.push(c),
							c._initReady ||
								((c._initReady = c.ready), (c.ready = y));
					...
					function la(a, b) {
						var c = this,
							d = c.ready().then(function () {
								...
								return (
									b && (b = b.substring(d.keyPrefix.length)),
									b
								);
							});
						return h(d, b), d;
					...
					var va = Promise,
						...
						gb = (function () {
							...
							return (
								...
								(a.prototype._wrapLibraryMethodsWithReady =
									function () {
										for (
											var a = 0, b = eb.length;
											a < b;
