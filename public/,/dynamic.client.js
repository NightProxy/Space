...
(() => {
	...
	var J = (e, t) => () => (
		...
		or = (e, t) => {
			for (var i in t) Lt(e, i, { get: t[i], enumerable: !0 });
		},
		oa = (e, t, i, r) => {
	...
	var ve = (e, t, i) => (
		...
		oa(
			t || !e || !e.__esModule
				? Lt(i, 'default', { value: e, enumerable: !0 })
				: i,
			e
		)
	);
	...
	var pn = J(ei => {
		...
		function ys(e, t, i) {
			...
			if (!st.test(e)) throw new TypeError('argument name is invalid');
			var a = n(t);
			if (a && !st.test(a))
	...
	var dn = J((Ys, Be) => {
		...
		function fn(e, t) {
			...
			if (
				...
				var r = {};
				return e.filter(ti).reduce(function (n, a) {
					var s = ii(a, t);
					return (n[s.name] = s), n;
				}, r);
			} else
				return e.filter(ti).map(function (n) {
					return ii(n, t);
				});
		}
		function ws(e) {
		...
		Be.exports = fn;
		Be.exports.parse = fn;
		Be.exports.parseString = ii;
		Be.exports.splitCookiesString = ws;
	});
	var Bn = J(() => {});
	var me = J((xt, Fn) => {
		(function (e, t) {
	...
	function ga(e) {
		...
		return (
			t
				.then(i => {
					i instanceof IDBCursor && yr.set(i, e);
				})
				.catch(() => {}),
			Mt.set(t, e),
			t
		...
		get(e, t, i) {
			if (e instanceof IDBTransaction) {
				...
				if (t === 'objectStoreNames')
					return e.objectStoreNames || gr.get(e);
				if (t === 'store')
	...
	function _a(e) {
		return e === IDBDatabase.prototype.transaction &&
			...
			? function (t, ...i) {
					let r = e.call(Le(this), t, ...i);
					return gr.set(r, t.sort ? t.sort() : [t]), Z(r);
				}
			: ya().includes(e)
				? function (...t) {
						return e.apply(Le(this), t), Z(yr.get(this));
					}
				: function (...t) {
						return Z(e.apply(Le(this), t));
					};
	}
	function va(e) {
	...
	xr(e => ({
		...e,
		get: (t, i, r) => _r(t, i) || e.get(t, i, r),
		has: (t, i) => !!_r(t, i) || e.has(t, i)
	}));
	var Ca = [
	...
	var te = { beforeExpr: !0 },
		...
		Ht = {};
	function F(e, t) {
		return t === void 0 && (t = {}), (t.keyword = e), (Ht[e] = new $(e, t));
	}
	var u = {
			num: new $('num', X),
			regexp: new $('regexp', X),
	...
	function ye(e) {
		return (
			br[e] || (br[e] = new RegExp('^(?:' + e.replace(/ /g, '|') + ')$'))
		);
	}
	function ge(e) {
		return e <= 65535
	...
	function Ma(e) {
		var t = {};
		for (var i in jt) t[i] = e && Ne(e, i) ? e[i] : jt[i];
		if (
...
Defaulting to 2020, but this will stop working in the future.`)),
		...
		return vr(t.onComment) && (t.onComment = Da(t, t.onComment)), t;
	}
	function Da(e, t) {
		return function (i, r, n, a, s, o) {
			var c = { type: i ? 'Block' : 'Line', value: r, start: n, end: a };
			e.locations && (c.loc = new et(this, s, o)),
	...
	var Xe = 0,
		...
		q = function (t, i, r) {
			...
			var n = '';
			t.allowReserved !== !0 &&
				((n = Bt[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3]),
				t.sourceType === 'module' && (n += ' await')),
				(this.reservedWords = ye(n));
			var a = (n ? n + ' ' : '') + Bt.strict;
			(this.reservedWordsStrict = ye(a)),
				(this.reservedWordsStrictBind = ye(a + ' ' + Bt.strictBind)),
				(this.input = String(i)),
				(this.containsEsc = !1),
				r
					? ((this.pos = r),
...
`,
	...
	ue.inGenerator.get = function () {
		return (
			(this.currentVarScope().flags & Ir) > 0 &&
			!this.currentVarScope().inClassFieldInit
		);
	};
	ue.inAsync.get = function () {
		return (
			(this.currentVarScope().flags & Wt) > 0 &&
			!this.currentVarScope().inClassFieldInit
		);
	};
	ue.canAwait.get = function () {
		for (var e = this.scopeStack.length - 1; e >= 0; e--) {
			...
			if (t.inClassFieldInit || t.flags & Me) return !1;
			if (t.flags & Ce) return (t.flags & Wt) > 0;
		}
		return (
	...
	R.parseFunctionStatement = function (e, t, i) {
		return this.next(), this.parseFunction(e, Re | (i ? 0 : Ut), !1, t);
	};
	...
	R.parseCatchClauseParam = function () {
		var e = this.parseBindingAtom(),
			t = e.type === 'Identifier';
		return (
			this.enterScope(t ? Nr : 0),
			this.checkLValPattern(e, t ? Or : fe),
	...
	R.parseVarId = function (e, t) {
		(e.id = this.parseBindingAtom()),
			this.checkLValPattern(e.id, t === 'var' ? Kt : fe, !1);
	};
	var Re = 1,
		Ut = 2,
		Fr = 4;
	R.parseFunction = function (e, t, i, r, n) {
		this.initFunction(e),
			(this.options.ecmaVersion >= 9 ||
				...
				(this.type === u.star && t & Ut && this.unexpected(),
				(e.generator = this.eat(u.star))),
			this.options.ecmaVersion >= 8 && (e.async = !!r),
			t & Re &&
				((e.id =
					t & Fr && this.type !== u.name ? null : this.parseIdent()),
				e.id &&
					!(t & Ut) &&
		...
		return (
			...
			this.enterScope(Gt(e.async, e.generator)),
			t & Re || (e.id = this.type === u.name ? this.parseIdent() : null),
	...
	R.parseClassElement = function (e) {
		...
		if (
			...
			var l = !i.static && Je(i, 'constructor'),
				p = l && e;
			l &&
				s !== 'method' &&
				this.raise(
	...
	R.parseClassStaticBlock = function (e) {
		...
		var t = this.labels;
		for (
			this.labels = [], this.enterScope(Me | zt);
			this.type !== u.braceR;
				...
				this.strict &&
					...
					r &&
						...
						i &&
							...
							(i[e.name] = !0)),
						t !== Br && this.declareName(e.name, t, e.start));
				break;
			case 'ChainExpression':
				this.raiseRecoverable(
					e.start,
			...
			(o.operator = this.value),
				...
				c
					...
					: this.strict &&
						...
						: o.operator === 'delete' && Vr(o.argument)
							? this.raiseRecoverable(
									o.start,
	...
	function Vr(e) {
		return (
			...
			(e.type === 'ChainExpression' && Vr(e.expression))
		);
	}
...
`
	...
	M.parseMethod = function (e, t, i) {
		...
		return (
			...
			(this.awaitPos = 0),
			(this.awaitIdentPos = 0),
			this.enterScope(Gt(t, r.generator) | zt | (i ? Mr : 0)),
			this.expect(u.parenL),
	...
	M.parseFunctionBody = function (e, t, i, r) {
		...
		if (n)
			...
			(this.labels = []),
				...
				this.strict && e.id && this.checkLValSimple(e.id, Br),
	...
	M.checkParams = function (e, t) {
		for (
			...
			var a = n[r];
			this.checkLValInnerPattern(a, Kt, t ? null : i);
		}
	};
	...
	xe.treatFunctionsAsVarInScope = function (e) {
		return e.flags & Ce || (!this.inModule && e.flags & Te);
	};
	...
	xe.currentVarScope = function () {
		for (var e = this.scopeStack.length - 1; ; e--) {
			var t = this.scopeStack[e];
			if (t.flags & qt) return t;
		}
	};
	xe.currentThisScope = function () {
		for (var e = this.scopeStack.length - 1; ; e--) {
			var t = this.scopeStack[e];
			if (t.flags & qt && !(t.flags & Tr)) return t;
		}
	};
	var it = function (t, i, r) {
			(this.type = ''),
				(this.start = i),
				(this.end = 0),
				t.options.locations && (this.loc = new et(t, r)),
	...
	De.finishNodeAt = function (e, t, i, r) {
		return $r.call(this, e, t, i, r);
	};
	...
	var jr =
		...
		Ur = jr + ' Extended_Pictographic',
		Hr = Ur,
		Wr = Hr + ' EBase EComp EMod EPres ExtPict',
		zr = Wr,
		Ua = zr,
		Ha = { 9: jr, 10: Ur, 11: Hr, 12: Wr, 13: zr, 14: Ua },
		Wa =
		...
		Ga = { 9: qr, 10: Gr, 11: Kr, 12: Qr, 13: Yr, 14: qa },
		Xr = {};
	function Ka(e) {
		var t = (Xr[e] = {
			binary: ye(Ha[e] + ' ' + Sr),
			binaryOfStrings: ye(za[e]),
			nonBinary: { General_Category: ye(Sr), Script: ye(Ga[e]) }
		});
	...
	for (Ye = 0, Vt = [9, 10, 11, 12, 13, 14]; Ye < Vt.length; Ye += 1)
		(Cr = Vt[Ye]), Ka(Cr);
	var Cr,
		Ye,
		Vt,
	...
	A.regexp_eatSyntaxCharacter = function (e) {
		var t = e.current();
		return Jr(t) ? ((e.lastIntValue = t), e.advance(), !0) : !1;
	};
	function Jr(e) {
		return (
			e === 36 ||
	...
	A.regexp_eatPatternCharacters = function (e) {
		for (var t = e.pos, i = 0; (i = e.current()) !== -1 && !Jr(i); )
			e.advance();
		return e.pos !== t;
	};
	...
	A.regexp_eatZero = function (e) {
		return e.current() === 48 && !rt(e.lookahead())
	...
	A.regexp_eatControlLetter = function (e) {
		var t = e.current();
		return Zr(t) ? ((e.lastIntValue = t % 32), e.advance(), !0) : !1;
	};
	function Zr(e) {
	...
	A.regexp_validateUnicodePropertyNameAndValue = function (e, t, i) {
		Ne(e.unicodeProperties.nonBinary, t) ||
			e.raise('Invalid property name'),
	...
	A.regexp_eatClassAtom = function (e) {
		...
		if (e.eat(92)) {
			...
			if (e.switchU) {
				var i = e.current();
				(i === 99 || an(i)) && e.raise('Invalid class escape'),
					e.raise('Invalid escape');
			}
			e.pos = t;
		}
	...
	A.regexp_eatHexDigits = function (e) {
		var t = e.pos,
			i = 0;
		for (e.lastIntValue = 0; rn((i = e.current())); )
			(e.lastIntValue = 16 * e.lastIntValue + nn(i)), e.advance();
		return e.pos !== t;
	};
	function rn(e) {
		return (
	...
	A.regexp_eatFixedHexDigits = function (e, t) {
		...
		for (var r = 0; r < t; ++r) {
			var n = e.current();
			if (!rn(n)) return (e.pos = i), !1;
			(e.lastIntValue = 16 * e.lastIntValue + nn(n)), e.advance();
		}
		return !0;
	};
	var Yt = function (t) {
			(this.type = t.type),
				...
				(this.end = t.end),
				t.options.locations &&
					(this.loc = new et(t, t.startLoc, t.endLoc)),
	...
	B.readRadixNumber = function (e) {
		...
		return (
			...
			this.input.charCodeAt(this.pos) === 110
				? ((i = sn(this.input.slice(t, this.pos))), ++this.pos)
	...
	B.readNumber = function (e) {
		...
		if (!i && !e && this.options.ecmaVersion >= 11 && r === 110) {
			var n = sn(this.input.slice(t, this.pos));
			return (
				++this.pos,
				he(this.fullCharCodeAtPos()) &&
					this.raise(this.pos, 'Identifier directly after number'),
	...
	B.tryReadTemplateToken = function () {
		...
		try {
			...
			if (e === on) this.readInvalidTemplateToken();
			else throw e;
		}
...
`;
	...
	var as = globalThis.fetch,
		...
		Xt = globalThis.Response,
		nt = globalThis.SharedWorker,
		un = globalThis.localStorage,
	...
	function ln(e, t) {
		let i = new nt(e, 'bare-mux-worker');
		return (
			t &&
				os.addEventListener('message', r => {
					if (r.data.type === 'getPort' && r.data.port) {
						...
						let n = new nt(e, 'bare-mux-worker');
			...
			if (self.clients)
				(this.port = Jt()),
					(this.channel.onmessage = r => {
						r.data.type === 'refreshPort' && (this.port = Jt());
					});
			else if (t && nt) {
		...
		async fetch(t, i) {
			...
			for (let c = 0; ; c++) {
				...
				let l = (
					...
					p = new Xt(ps.includes(l.status) ? void 0 : l.body, {
						headers: new Headers(l.headers),
						status: l.status,
						statusText: l.statusText
					});
				(p.rawHeaders = l.headers),
					(p.rawResponse = new Xt(l.body)),
...
`,
	...
	var mn,
		...
		As = {
			...
			BlockStatement: (vn = function (e, t) {
				let i = t.indent.repeat(t.indentLevel++),
					{ lineEnd: r, writeComments: n } = t,
					a = i + t.indent;
				t.write('{');
			...
			ForStatement(e, t) {
				if ((t.write('for ('), e.init != null)) {
					let { init: i } = e;
					i.type[0] === 'V' ? ri(t, i) : this[i.type](i, t);
				}
				t.write('; '),
			...
			ForInStatement: (mn = function (e, t) {
			...
			FunctionDeclaration: (yn = function (e, t) {
				t.write(
					(e.async ? 'async ' : '') +
			...
			AwaitExpression(e, t) {
				t.write('await ', e), ct(t, e.argument, e);
			},
			TemplateLiteral(e, t) {
			...
			TaggedTemplateExpression(e, t) {
				ct(t, e.tag, e), this[e.quasi.type](e.quasi, t);
			},
			ArrayExpression: (_n = function (e, t) {
			...
			BinaryExpression: (xn = function (e, t) {
				let i = e.operator === 'in';
				i && t.write('('),
					ct(t, e.left, e, !1),
					t.write(' ' + e.operator + ' '),
...
`
	...
	var ai = class {
			constructor(t) {
				...
				this.path = Ls;
				this.acorn = { parse: cn };
				this.bare = { BareClient: at };
				this.base64 = { encode: btoa, decode: atob };
				this.estree = { generate: wn };
				this.cookie = Rs;
				this.setCookieParser = Sn.parse;
				this.ctx = t;
			}
		},
		Cn = ai;
	function si(e, t, i, r, n = '', a = !1, s = '') {
	...
	function pi(e, t = {}) {
		if (!(t.type == 'AssignmentExpression' && t.left == e)) {
			...
			if (e.callee.type == 'MemberExpression') {
				...
				e.callee.object.name == 'eval' && ut(e);
			}
...
${t}`;
	...
	var gi = class {
			constructor(t) {
				(this.ctx = t),
					(this.html = new Fe(this)),
					(this.srcset = kn),
					(this.js = new $e(this)),
					(this.css = new Ve(this)),
					(this.man = new je(this));
			}
		},
		An = gi;
	async function Pn(e) {
...
self.document?.currentScript?.remove();`
	...
	var Ki = e =>
			e
				...
				: {},
		ze = (e = []) => e.map(t => `${t.name}=${t.value}`).join('; ');
	function Qi(e) {
		if (
			...
			e.__dynamic.define(e.document, 'cookie', {
				...
				set(t) {
					...
					var n = Ki(e.__dynamic.cookie.str || '');
					(n[i.name] = i.value),
						(e.__dynamic.cookie.str = ze(
	...
	var ir = ve(Xn(), 1),
		ta = ve(Zn(), 1),
		ea = location.origin + navigator.userAgent,
		Os = {
			encode: (e, t = 2) =>
				e &&
				encodeURIComponent(
		...
		Fs = {
			encode: e =>
				e && ir.default.encrypt(e, ea).toString().substring(10),
			decode: e =>
				e &&
				ir.default.decrypt('U2FsdGVkX1' + e, ea).toString(ta.default)
		},
	...
	var At = class {
		constructor(t) {
			this.modules = new Cn(this);
			this.util = new Rn(this);
			this.meta = new Tn(this);
			this.regex = new He(this);
			this.rewrite = new An(this);
			this.url = new In(this);
			this.is = new Mn(this);
	...
	function Pt(e, t = {}, i = '') {
		...
		let r = new At(e.__dynamic$config);
		(e.__dynamic$baseURL =
			i ||
			e.__dynamic$url ||
