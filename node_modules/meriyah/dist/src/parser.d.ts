...
import { Context, ParserState, PropertyKind, Origin, Flags, OnComment, OnInsertedSemicolon, OnToken, BindingKind, HoistedClassFlags, HoistedFunctionFlags, ScopeState } from './common';
...
export declare function parseStaticBlock(parser: ParserState, context: Context, scope: ScopeState | undefined, start: number, line: number, column: number): ESTree.StaticBlock;
...
export declare function parseExpression(parser: ParserState, context: Context, canAssign: 0 | 1, inGroup: 0 | 1, start: number, line: number, column: number): ESTree.Expression;
...
export declare function parseAsyncExpression(parser: ParserState, context: Context, inGroup: 0 | 1, isLHS: 0 | 1, canAssign: 0 | 1, inNew: 0 | 1, start: number, line: number, column: number): ESTree.FunctionExpression | ESTree.ArrowFunctionExpression | ESTree.CallExpression | ESTree.Identifier;
...
export declare function parsePrimaryExpression(parser: ParserState, context: Context, kind: BindingKind, inNew: 0 | 1, canAssign: 0 | 1, inGroup: 0 | 1, isLHS: 0 | 1, start: number, line: number, column: number): any;
